...
public class SmbFileInputStream extends InputStream {
    ...
    SmbFileInputStream(SmbFile file, int openFlags) throws SmbException, MalformedURLException, UnknownHostException {
        ...
        if ((file.tree.session.transport.server.capabilities & jcifs.smb.SmbConstants.CAP_LARGE_READX) == jcifs.smb.SmbConstants.CAP_LARGE_READX) {
            readSizeFile = Math.min(jcifs.smb.SmbConstants.RCV_BUF_SIZE - 70, 0xFFFF - 70);
        } else {
